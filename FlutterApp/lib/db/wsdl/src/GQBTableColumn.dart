...
class GQBTableColumn  implements GQBISerializableObject
{
    XmlElement?  __source;
    ...
    String? Name;
    GQBColumnType Type=GQBColumnType.Integer;
    ...
    Future<void> serialize(XmlElement __parent, GQBRequestResultHandler __handler) async
    {
        ...
        var __TypeItemElement=__handler.writeElementWithType(Type,GQBColumnType, "Type", "http://schemas.datacontract.org/2004/07/DB.WebService.Contract", __parent, false);
        if(__TypeItemElement != null)
        {
            __TypeItemElement.innerText = this.Type.toString();
        }
    }
    ...
    Future<bool> loadProperty(XmlElement __node, GQBRequestResultHandler __handler) async
    {
        ...
        if( __node.name.local=="Type")
        {
            if( GQBHelper.isValue(__node,  "Type"))
            {
                this.Type = GQBColumnType.fromString(__node.innerText)!;
            }
            return true;
        }
        return false;
